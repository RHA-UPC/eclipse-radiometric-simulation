...
en \url{\repourl}. El código se distribuye bajo AGPL-3.0-only y el material
escrito bajo CC BY-SA 4.0. Los datos de terceros que el trabajo consume
conservan sus propios términos, listados en \texttt{THIRD-PARTY-DATA.md}, y
deben descargarse de su origen.
